...
const uri = `mongodb://${encodeURIComponent(username)}:${encodeURIComponent(password)}@65.62.37.57:27017,65.62.37.71:27017,65.62.37.64:27017/stitch_store?replicaSet=atlas-l5pynp-shard-0&ssl=true&authSource=admin&retryWrites=true&w=majority&appName=Clusterfareed&tlsAllowInvalidHostnames=true`;
