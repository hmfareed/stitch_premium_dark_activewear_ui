...
const transporter = nodemailer.createTransport({
  ...
  connectionTimeout: 3000, // 3 seconds max connection attempt
  greetingTimeout: 3000,   // 3 seconds max greeting wait
  socketTimeout: 5000,     // 5 seconds max socket inactivity
});
