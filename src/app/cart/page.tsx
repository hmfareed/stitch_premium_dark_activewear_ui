  ...
  if (cart.length === 0) {
    return (
      <div className="animate-fade-in-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', padding: '0 24px', textAlign: 'center' }}>
        <span className="material-symbols-outlined" style={{ fontSize: 64, color: 'var(--on-surface-variant)', opacity: 0.2, marginBottom: 16 }}>shopping_bag</span>
        <h2 style={{ fontFamily: 'var(--font-lexend)', fontSize: 22, fontWeight: 800, color: 'var(--foreground)', marginBottom: 8 }}>Your cart is empty</h2>
        <p style={{ fontFamily: 'var(--font-inter)', color: 'var(--on-surface-variant)', marginBottom: 24, fontSize: 14 }}>Premium performance gear is waiting for you.</p>
